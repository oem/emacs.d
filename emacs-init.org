...
#+BEGIN_SRC emacs-lisp :tangle yes
    ...
    (set-face-attribute 'fixed-pitch nil :family "IBM Plex Mono" :weight 'regular :height 140)
    (set-face-attribute 'variable-pitch nil :family "IBM Plex Mono" :height 160 :weight 'light)
#+END_SRC
