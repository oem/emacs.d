...
#+BEGIN_SRC emacs-lisp :tangle yes
    ...
    (set-face-attribute 'fixed-pitch nil :family "IBM Plex Mono" :weight 'bold :height 150)
    (set-face-attribute 'variable-pitch nil :family "IBM Plex Mono" :height 150 :weight 'light)
#+END_SRC
