...
** TODO add a better keybind to toggle between two buffers
** TODO make a jj evil escape that is not interfering in non insert modes
...
#+BEGIN_SRC emacs-lisp :tangle yes
    (setq org-agenda-files (list "~/org" "~/.emacs.d/emacs-init.org"))
#+END_SRC

** TODO add org-drill
** TODO setup archiving of done tasks
** TODO set up some better keybinds for orga things
* Languages
...
** TODO add magit
** Python
*** TODO add  error checking and linting/autocorrecting
** Ruby
*** TODO add error checking
*** TODO add formatting
