...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit default :foreground "#b6b6b6" :height (lambda (base) (truncate (* (face-attribute (quote fixed-pitch) :height nil (quote default)) 1.4)))))))
 '(org-level-2 ((t (:inherit default :foreground "#d1d1d1" :weight thin :height (lambda (base) (truncate (* (face-attribute (quote fixed-pitch) :height nil (quote default)) 1.3)))))))
