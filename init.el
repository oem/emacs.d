...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(company-echo-common ((t (:family "IBM PLex Mono"))))
 '(company-preview ((t (:background "blue4" :foreground "wheat" :family "IBM Plex Mono"))))
 '(company-scrollbar-bg ((t (:background "gold" :family "IBM Plex Mono"))))
 '(company-scrollbar-fg ((t (:background "red" :family "IBM PLex Mono"))))
 '(company-tooltip ((t (:background "yellow" :foreground "black" :weight semi-bold :family "IBM Plex Mono"))))
 '(company-tooltip-annotation ((t (:foreground "red4" :family "IBM Plex Mono"))))
 '(company-tooltip-common ((t (:foreground "red" :family "IBM Plex Mono"))))
 '(flycheck-error ((t (:background "#612302" :foreground "red1" :weight semi-bold))))
 '(flycheck-warning ((t (:background "#614010" :foreground "DarkOrange" :weight semi-bold))))
 ...
 '(font-lock-string-face ((t (:inherit fixed-pitch :foreground "#fd8273"))))
 ...
 '(org-done ((t (:inherit nil :foreground "#717171" :weight thin))))
 ...
 '(org-level-2 ((t (:inherit default :foreground "#ccdae4" :weight semi-bold :height (lambda (base) (truncate (* (face-attribute (quote fixed-pitch) :height nil (quote default)) 1.3)))))))
 '(org-level-3 ((t (:inherit default :foreground "#ccdae6" :weight semi-bold :height (lambda (base) (truncate (* (face-attribute (quote fixed-pitch) :height nil (quote default)) 1.2)))))))
 '(org-link ((t (:inherit link :foreground "#005bbb" :underline nil :weight bold))))
 '(org-todo ((t (:inherit nil :foreground "#7f7f7f" :weight thin)))))
