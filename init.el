...
(custom-set-faces
 ...
 '(org-block ((t (:foreground "#d1d1d1" :weight semi-bold :height 0.9 :family "IBM Plex Mono"))))
 '(org-block-begin-line ((t (:inherit org-meta-line :weight semi-bold :family "IBM Plex Mono"))))
 '(org-block-end-line ((t (:inherit org-block-begin-line :weight semi-bold :family "IBM Plex Mono"))))
